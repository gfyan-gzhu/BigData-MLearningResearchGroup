...
# Author: A Dual-Stage Attention-Based Recurrent Neural Network for Time Series Prediction
...
class AttnEncoder(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.lstm = nn.LSTM(input_size=config.input_size, hidden_size=config.hidden_size, num_layers=1)
        self.attn1 = nn.Linear(in_features=2 * config.hidden_size, out_features=self.T)

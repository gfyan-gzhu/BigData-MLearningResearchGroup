...
tokenized_dataset = NewsTitles.map(
    tokenize_function, batched=True,
    remove_columns=['Date', 'Title', 'Content', 'MediaSrc', 'Title_seg']
)
...
train_dataloader = DataLoader(
    downsampled_dataset["train"], shuffle=True, batch_size=50,
    collate_fn=whole_word_masking_data_collator
)
validation_dataloader = DataLoader(
    downsampled_dataset["test"], batch_size=50,
    collate_fn=whole_word_masking_data_collator
)
